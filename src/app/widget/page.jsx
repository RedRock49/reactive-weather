...
export default function Page() {
  useEffect(() => {
    ...
    var containerImage = document.getElementById("mainContainer");
    switch (currentCond.WeatherIcon) {
      ...
      case 43:
      case 44:
        imageEl.setAttribute("src", "./Forecast_Icons/Cloudy_anytime.svg"); //snow(moon)
        // containerImage.style.backgroundImage =
        //   "url('./Forecast_Backgrounds/Cloudy_anytime.jpg')";
        imageEl.setAttribute("width", 50);
        imageEl.setAttribute("height", 50);
        break;
    }
  });
